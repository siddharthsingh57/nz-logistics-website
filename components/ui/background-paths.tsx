...
/* ─── FloatingPaths ──────────────────────────────────────────────────────── */
/**
 * Animated SVG path lines — used as a decorative background layer.
 *
 * @param position  - 1 or -1, mirrors the paths for the two-layer effect
 * @param color     - CSS color string; defaults to currentColor (inherit from parent)
 */
...
/* ─── BackgroundPaths (full-page component) ──────────────────────────────── */
/**
 * Full-page hero component with floating animated paths and animated title.
 * Use FloatingPaths directly if you only need the background layer.
 */
